...
## Slide 8: CLAUDE.md (약 1분 30초)

**문제 1 — 매번 전체 탐색:** Claude는 작업할 때마다 프로젝트 구조를 파악하기 위해 디렉토리를 탐색 → 시간/비용 낭비
**문제 2 — 매번 같은 지시:** "한국어로 응답해", "DTO는 이 형식으로" 등 범용 규칙을 매번 반복

**해결:** CLAUDE.md에 프로젝트 구조 + 범용 지침을 적어두면, Claude가 자동으로 읽고 따른다
